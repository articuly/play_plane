...
function Enemy3Plane(x,y){
	init_data = {
		...
		path : "image/enemy3/",
		image_files : ["enemy3_n1.png","enemy3_down1.png","enemy3_down2.png","enemy3_down3.png","enemy3_down4.png","enemy3_down5.png","enemy3_down6.png"],
		first_frame : 0,
		last_frame : 0,
		current_frame : 0,
		speed : 1,
...
Bullet1.prototype = new Sprite()

Bullet1.prototype.fly = function(){
	this.movies()
	this.div.style.top = (this.div.offsetTop - this.speed )+ "px"
	this.div.style.left = (this.div.offsetLeft - this.speed*0.8)+"px"
	if (this.div.offsetTop <= 0){
		this.dead = true
		}
	}
...
Bullet2.prototype.fly = function(){
	this.movies()
	this.div.style.top = (this.div.offsetTop - this.speed )+ "px"
	this.div.style.left = (this.div.offsetLeft + this.speed*0.8) +"px"
	if (this.div.offsetTop <= 0){
